# Manual to Automation @ <a href="https://sky.co.uk/"><img src="https://logos-world.net/wp-content/uploads/2021/02/Sky-Logo.png" alt="playwright" height="27" /></a> - Lesson 4 - Accessibility Using Axe
...
```sh
git clone https://github.com/Manual-To-Automation-Sky/Java-Lesson-4-Accessibility-Demo.git.
```
* Move into the directory that you just cloned by typing
```sh
cd Java-Lesson-4-Accessibility-Demo
```
